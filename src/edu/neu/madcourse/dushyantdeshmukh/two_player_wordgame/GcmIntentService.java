...
public class GcmIntentService extends IntentService {
  ...
  private boolean isActivityActive() {
    SharedPreferences prefs = getSharedPreferences(Constants.SHARED_PREF_CONST, Context.MODE_PRIVATE);
    boolean isActive = prefs.getBoolean(Constants.ACTIVITY_ACTIVE_PREF, false);
    return isActive;
  }
  ...
  private void sendNotification(String data) {
    getSharedPreferences(Constants.ACTIVITY_ACTIVE_PREF,
        Context.MODE_PRIVATE).edit().putString(Constants.KEY_NOTIFICATION_DATA, data).commit();
    Log.d(TAG, "Storing NOTIFICATION_DATA in SharedPref = " + data);

    mNotificationManager = (NotificationManager) this
        .getSystemService(Context.NOTIFICATION_SERVICE);

    Intent i = new Intent(this, TwoPlayerWordGame.class);
